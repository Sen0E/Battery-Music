...
class SearchListItem {
  ...
  factory SearchListItem.fromMap(Map<String, dynamic> map) {
  ...
  factory SearchListItem.fromJson(String source) =>
      SearchListItem.fromMap(json.decode(source));
  String toJson() => json.encode(toMap());
...
class SearchKeywords {
  ...
  /// 歌曲列表
  final List<SearchListItem>? lists;
    ...
    return SearchKeywords(
      ...
      lists: map['lists'] != null
          ? List<SearchListItem>.from(
              (map['lists'] as List).map(
                (x) => SearchListItem.fromMap(x as Map<String, dynamic>),
              ),
            )
          : null,
  ...
  factory SearchKeywords.fromFullJson(String fullJson) {
    Map<String, dynamic> fullMap = json.decode(fullJson);
    return SearchKeywords.fromMap(fullMap['data'] as Map<String, dynamic>);
  }
